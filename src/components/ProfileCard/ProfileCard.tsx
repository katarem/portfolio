            ...
            <section className='profile-container'>
                ...
                <div className='profile-details'>
                    ...
                    <div className='profile-links'>
                        <LinkButton name='GitHub' url='https://github.com/katarem' src='/icons/github.svg'/>
                        <LinkButton name='LinkedIn' url='https://www.linkedin.com/in/cristian-m-espinosa-leal-129380268' src='/icons/linkedin.svg'/>       
                    </div>
                </div>
            </section>
        </article>
